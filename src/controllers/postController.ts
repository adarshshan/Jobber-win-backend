...
class PostController {
  ...
  async savePost(req: Request, res: Response) {
    try {
      ...
      const result = await this.postServices.savePost(
        userId,
        imageUrl,
        caption
      );
      ...
      if (error instanceof DatabaseError) {
        ...
        res.status(500).json({
          success: false,
          message:
            error.message || "An unexpected error occurred while saving post.",
        });
      } else {
        console.error("Unexpected error in savePost controller:", error);
        res.status(500).json({
          success: false,
          message: "An unexpected error occurred while saving post.",
        });
      }
    }
  }
  ...
  async getPostForHome(req: Request, res: Response) {
    try {
      ...
      res.json({
        success: true,
        data: result,
        message: "Posts for home feed fetched successfully.",
      });
    } catch (error) {
      if (error instanceof DatabaseError) {
        ...
        res.status(500).json({
          success: false,
          message: "Internal server error while fetching posts for home feed.",
        });
      } else if (error instanceof Error) {
        ...
        res.status(500).json({
          ...
          message:
            error.message ||
            "An unexpected error occurred while fetching posts for home feed.",
        });
      } else {
    ...
    try {
      ...
      if (error instanceof DatabaseError) {
        ...
        res.status(500).json({
          success: false,
          message:
            error.message || "An unexpected error occurred while liking post.",
        });
      } else {
    ...
    try {
      ...
      if (error instanceof DatabaseError) {
        ...
        res.status(500).json({
          ...
          message:
            error.message ||
            "An unexpected error occurred while unliking post.",
        });
      } else {
  ...
  async sendComment(req: Request, res: Response) {
    try {
      ...
      const result = await this.postServices.sendComment(
        postId,
        userId,
        comment
      );
      ...
      if (error instanceof DatabaseError) {
        ...
        res.status(500).json({
          success: false,
          message: "Internal server error while sending comment.",
        });
      } else if (error instanceof Error) {
        ...
        res.status(500).json({
          ...
          message:
            error.message ||
            "An unexpected error occurred while sending comment.",
        });
      } else {
        console.error("Unexpected error in sendComment controller:", error);
        res.status(500).json({
          success: false,
          message: "An unexpected error occurred while sending comment.",
        });
      }
    }
  }
  ...
  async replyComment(req: Request, res: Response) {
    try {
      ...
      const result = await this.postServices.replyComment(
        reply,
        commentId,
        userId
      );
      ...
      if (error instanceof DatabaseError) {
        ...
        res.status(500).json({
          ...
          message:
            error.message ||
            "An unexpected error occurred while replying to comment.",
        });
      } else {
        console.error("Unexpected error in replyComment controller:", error);
        res.status(500).json({
          success: false,
          message: "An unexpected error occurred while replying to comment.",
        });
      }
    }
  }
  async deletePost(req: Request, res: Response) {
    try {
      ...
      if (error instanceof NotFoundError) {
        res
          .status(404)
          .json({ success: false, message: "Post not found for deletion." });
  ...
  async updateCaption(req: Request, res: Response) {
    try {
      ...
      if (error instanceof NotFoundError) {
        res.status(404).json({
          success: false,
          message: "Post not found for updating caption.",
        });
      } else if (error instanceof DatabaseError) {
        console.error("Database error in updateCaption controller:", error);
        res.status(500).json({
          success: false,
          message: "Internal server error while updating caption.",
        });
      } else if (error instanceof Error) {
        ...
        res.status(500).json({
          ...
          message:
            error.message ||
            "An unexpected error occurred while updating caption.",
        });
      } else {
        console.error("Unexpected error in updateCaption controller:", error);
        res.status(500).json({
          success: false,
          message: "An unexpected error occurred while updating caption.",
        });
      }
    }
  }
  async postShareSuggestedUsers(req: Request, res: Response) {
    try {
      ...
      if (error instanceof DatabaseError) {
        console.error(
          "Database error in postShareSuggestedUsers controller:",
          error
        );
        res.status(500).json({
          success: false,
          message: "Internal server error while fetching suggested users.",
        });
      } else if (error instanceof Error) {
        ...
        console.error(
          "Unexpected error in postShareSuggestedUsers controller:",
          error
        );
        res.status(500).json({
          success: false,
  ...
  async getSinglePostDetails(req: Request, res: Response) {
    try {
      ...
      if (error instanceof NotFoundError) {
        ...
        console.error(
          "Database error in getSinglePostDetails controller:",
          error
        );
        res.status(500).json({
          success: false,
          message: "Internal server error while fetching post details.",
        });
      } else if (error instanceof Error) {
        ...
        res.status(500).json({
          ...
          message:
            error.message ||
            "An unexpected error occurred while fetching post details.",
        });
      } else {
        console.error(
          "Unexpected error in getSinglePostDetails controller:",
          error
        );
        res.status(500).json({
          success: false,
  ...
  async uploadPostImage(req: Request, res: Response) {
    try {
      ...
      const firebaseFile = bucket.file(
        `activity_images/${Date.now()}-${file.originalname}`
      );
